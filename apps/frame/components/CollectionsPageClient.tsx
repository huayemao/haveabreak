...
import CollectionManager from '@haveabreak/frame/components/CollectionManager';
import { useSearchParams } from 'next/navigation';
import { useRouter, usePathname } from '@/i18n/routing';
import { Collection, MediaItem } from '@haveabreak/frame/types';
...
export default function CollectionsPageClient({ 
  ...
  const handleSelectCollection = (id: string | null) => {
    if (id) {
      ...
      router.push(`/frame/collections/detail?collection=${id}`);
    } else {
