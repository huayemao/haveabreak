  ...
  return (
    ...
    >
      <div className="space-y-4">
        ...
        <h1 className="font-display text-5xl font-extrabold tracking-tight">{t('timer.title')}</h1>
        <p className="text-fg-muted text-lg">{t('timer.subtitle')}</p>
      </div>

      <div className="p-8 rounded-[32px] shadow-extruded bg-bg-base w-full space-y-8">
        <div className="space-y-4">
          <h3 className="font-display font-bold text-xl">{t('timer.minutes')}</h3>
