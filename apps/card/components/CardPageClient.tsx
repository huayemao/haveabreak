...
import { useCardStore, selectQuotesWithBooks } from '@haveabreak/card/store';
import { Quote } from '@haveabreak/card/types';
...
import { useSwipeNavigation } from '@haveabreak/utils/hooks/useSwipeNavigation';
import { useAutoPlay } from '@haveabreak/utils/hooks/useAutoPlay';
