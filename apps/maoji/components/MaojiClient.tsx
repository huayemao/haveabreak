...
import { EPD_SPECS, getEpdSpec } from '@haveabreak/maoji/epdSpecs';
import { renderCanvasToEpdBytes } from '@haveabreak/maoji/utils/dither';
import {
  enableNfc, prepareWrite, onWriteProgress, onWriteSuccess, onWriteError, NfcStructuredError
} from '@haveabreak/maoji/nfcService';
import { toast } from 'sonner';
import ScreenSelector from './ScreenSelector';
import TemplatePanel from './TemplatePanel';
import CanvasEditor from './CanvasEditor';
import NfcWriteDialog from './NfcWriteDialog';
import NfcErrorPanel from './NfcErrorPanel';
