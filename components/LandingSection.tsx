  ...
  return (
    ...
    >
      <div className="text-center space-y-6">
        <h2 className="font-display text-4xl font-extrabold  text-fg-primary tracking-tight">{dict.landingH2}</h2>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="p-8 rounded-[32px] shadow-extruded bg-bg-base space-y-6">
          ...
          <p className="  leading-relaxed">{dict.landingF1Desc}</p>
        </div>
        ...
        <div className="p-8 rounded-[32px] shadow-extruded bg-bg-base space-y-6">
          ...
          <p className="  leading-relaxed">{dict.landingF2Desc}</p>
        </div>
        ...
        <div className="p-8 rounded-[32px] shadow-extruded bg-bg-base space-y-6">
          ...
          <p className="  leading-relaxed">{dict.landingF3Desc}</p>
        </div>
      </div>
    </motion.section>
  );
