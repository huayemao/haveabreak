...
export default function LandingSection({ dict }: LandingSectionProps) {
  return (
    <motion.section 
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    >
      <div className="text-center space-y-6">
        <h2 className="font-display text-4xl font-extrabold text-primary tracking-tight">{dict.landingH2}</h2>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="p-8 rounded-[32px] shadow-extruded bg-bg-base space-y-6">
          ...
          <h3 className="font-display font-bold text-xl">{dict.landingF1Title}</h3>
          <p className="text-muted leading-relaxed">{dict.landingF1Desc}</p>
        </div>
        ...
        <div className="p-8 rounded-[32px] shadow-extruded bg-bg-base space-y-6">
          ...
          <h3 className="font-display font-bold text-xl">{dict.landingF2Title}</h3>
          <p className="text-muted leading-relaxed">{dict.landingF2Desc}</p>
        </div>
        ...
        <div className="p-8 rounded-[32px] shadow-extruded bg-bg-base space-y-6">
          ...
          <h3 className="font-display font-bold text-xl">{dict.landingF3Title}</h3>
          <p className="text-muted leading-relaxed">{dict.landingF3Desc}</p>
        </div>
      </div>
    </motion.section>
  );
